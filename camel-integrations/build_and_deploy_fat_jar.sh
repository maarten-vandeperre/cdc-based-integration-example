...
podman build --platform linux/amd64 -t quay.io/rh_ee_mvandepe/cdc-based-integration-example-camel:$VERSION-fatjar \
        -f /src/main/container/ContainerImageDefinition \
        .
podman push quay.io/rh_ee_mvandepe/cdc-based-integration-example-camel:$VERSION-fatjar
